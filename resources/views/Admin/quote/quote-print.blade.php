      ...
      <div class="col-12">
        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row invoice-info">
            ...
            <!-- /.col -->
            <div class="col-sm-6 invoice-col align-content-end">
              <strong>Devis</strong>
              <address>
          ...
          <div class="row no-print">
            <div class="col-12">
              ...
              <a href="{{route("quote.transfer",["id"=>$quote->id])}}" target="_blank" class="btn btn-info"><i class="fas fa-file-invoice"></i> Facturiser</a>
            </div>
          </div>
        </div>
        <!-- /.invoice -->
